    ...
    return (
      ...
      >
        <div className="flex flex-col italic items-start gap-1">
          ...
          <span className="text-sm font-semibold tracking-wide opacity-90 italic leading-snug">VIEW UPDATED DATES</span>
        </div>
  ...
  return (
    ...
    >
      <div className="flex flex-col leading-none italic items-end gap-0">
        ...
        <span className="text-lg font-semibold tracking-wide opacity-90 italic">VIEW UPDATED DATES</span>
      </div>
