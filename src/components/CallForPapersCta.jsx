    ...
    return (
      ...
      >
        <div className="flex flex-col italic items-start gap-1">
          <span className="text-2xl font-semibold leading-tight">CALL FOR ABSTRACT</span>
          <span className="text-sm font-semibold tracking-wide opacity-90 italic leading-snug">SUBMISSION DEADLINE MAY 15TH, 2026</span>
        </div>
  ...
  return (
    ...
    >
      <div className="flex flex-col leading-none italic items-end gap-0">
        <span className="text-[40px] font-semibold">CALL FOR ABSTRACT</span>
        <span className="text-lg font-semibold tracking-wide opacity-90 italic">SUBMISSION DEADLINE MAY 15TH, 2026</span>
      </div>
